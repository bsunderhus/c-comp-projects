...
Lista_Arv* concatenaNaLista (Lista_Arv* lista){
    ...
    Lista_Arv* aux3 = aux2->prox; //terceiro termo da lista
    int i = 0;
...
//Função que faz chamada de funcao contida no TadArvore.
void listaToHuff(bitmap* bm, Lista_Arv* lista, FILE* out){
  HuffToBmp(bm,lista->arv,out);
}
